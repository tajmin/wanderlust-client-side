    ...
    return (
        <div>
            ...
            <div className="container mx-auto grid grid-cols-2">
                <div className="">
                    <form className="grid grid-cols-1 gap-8 text-left text-lg text-gray-500" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input className="w-1/3 py-3 rounded hover:bg-blue-600 bg-blue-500 cursor-pointer text-white font-bold" type="submit" value="Confirm Booking" />
                    </form>
                </div>
