    ...
    return (
        <div className="bg-gray-100">
            <div className="container max-w-7xl mx-auto py-10 shadow-2xl bg-white">
                <h1 className="text-xl xl:text-5xl text-gray-600 py-8 xl:py-14">About Wonderlust</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    <div className="px-14 py-10 text-left">
                        ...
                        <p className="text-gray-500">
                            ...
                            <br /> <br />
                            In 2012, Wonderlust, Rachel Taylor and Jody Daunton, came together to create a high-quality lifestyle publication that inspires a connection to the great outdoors, considered ways of living, environmental stewardship and a sense of fulfilment in our everyday lives.
                            <br /> <br />
                    ...
                    <div className="px-14 py-10 text-left">
                        ...
                        <p className="text-gray-500">
                            Wonderlust's founder grew up in rural Minnesota with most of his childhood spent outdoors. On the heels of a demanding startup job, Jon found himself burned out and longing for the role nature played in his youth. He quit and left the city behind in a 26’ Airstream trailer to take time to reflect. <br /> <br />
